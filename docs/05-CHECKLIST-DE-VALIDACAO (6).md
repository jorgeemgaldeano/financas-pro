...
## 18. Validação da refatoração v0.3.11
...
- [ ] Executar `npm run build`.
- [ ] Executar `npm run preview`.
- [ ] Confirmar exibição da versão `v0.3.11`.
- [ ] Confirmar ausência de erro crítico no console.

### Dinheiro

- [ ] Criar lançamento com valor monetário.
- [ ] Criar simulação com valor monetário.
- [ ] Criar despesa compartilhada com valor monetário.
- [ ] Registrar amortização com valor monetário.
- [ ] Confirmar exibição dos valores em Real.

### Datas

- [ ] Criar lançamento com data no padrão `dd/mm/aaaa`.
- [ ] Filtrar lançamentos por data inicial e final.
- [ ] Criar compra parcelada com data da primeira parcela.
- [ ] Criar dívida e amortização com data.
- [ ] Confirmar que a exibição continua em `dd/mm/aaaa`.
- [ ] Confirmar que o backup preserva datas internas em `YYYY-MM-DD`.
...
- [ ] Tentar restaurar backup inválido e confirmar que dados atuais não são apagados.
